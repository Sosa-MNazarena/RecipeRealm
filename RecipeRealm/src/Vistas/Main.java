        ...
        do {
            ...
            switch (opcion) {
                case 0: // Aficionado
                    ...
                    JOptionPane.showMessageDialog(null, "Bienvenido " + aficionado.getNombre(), "Aficionado", 0, iconAficionado);
                    String[] opciones = {"Recetas", "Favoritos", "Busqueda", "Salir"};
                    int opcionElegida = 0;
                    do {
                ...
                case 1: // Chef
                    ...
                    String[] opcionesChef = {"Recetas", "Favoritos", "Busqueda", "Salir"};
