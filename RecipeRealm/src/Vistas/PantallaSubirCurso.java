	...
	public PantallaSubirCurso() {
		...
		btnPublicar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String respuesta= Cursos.publicarCurso(inputTitulo.getText(), inputLugar.getText(), LocalDate.parse(inputFecha.getText()), 
						Integer.parseInt(inputCupos.getText()), Double.parseDouble(inputPrecio.getText()), LocalTime.parse(inputHorario.getText()));
